...
# -*- coding: utf-8 -*-
##############################################################################
# eval_aldous_broder_reverse.py - evaluate the reverse Aldous/Broder
#                                 implementation
# Eric Conrad
...
rows, cols = 20, 30
runs = 40
filename = "stats/eval_aldous_broder_reverse.txt"
title = "Reverse Aldous/Broder algorithm (last exit)"
