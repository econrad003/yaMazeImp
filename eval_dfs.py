...
# -*- coding: utf-8 -*-
##############################################################################
# eval_hunt_and_kill.py - evaluate the hunt and kill algorithm
# Eric Conrad
...
##############################################################################
"""
eval_dfs.py - evaluate the recursive backtracker algorithm
Copyright ©2020 by Eric Conrad
...
with open(filename, 'w') as fp:
    ...
    fp.write("    Large diameter compared to other algorithms.\n")
    fp.write("    Fewer dead ends than most other algorithms.\n")
print("Saved to " + filename)

# END: eval_hunt_and_kill.py
