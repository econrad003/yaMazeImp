...
# -*- coding: utf-8 -*-
##############################################################################
# eval_heap_search.py - evaluate the heap search algorithm
# Eric Conrad
...
rows, cols = 20, 30
runs = 20
filename = "stats/eval_heapSearch.txt"
title = "heap search algorithm"
...
with open(filename, 'w') as fp:
    ...
    fp.write("    These mazes have unusual texture." \
             + "  Check texturizer results.\n")
    fp.write("    High dead end counts.\n")
