...
# -*- coding: utf-8 -*-
##############################################################################
# eval_binary_tree.py - evaluate the binary tree implementation
# Eric Conrad
...
rows, cols = 20, 30
runs = 20
filename = "stats/eval_binaryTree.txt"
title = "Binary Tree algorithm (N/E)"
parameters = "Rectangular_Grid(%d, %d), bias=50%%" % (rows, cols)
