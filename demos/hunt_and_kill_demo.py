...
# -*- coding: utf-8 -*-
##############################################################################
# hunt_and_kill_demo.py - test the hunt and kill maze algorithm
# Eric Conrad
...
##############################################################################
"""
hunt_and_kill_demo.py - test the hunt and kill implementation
Copyright ©2020 by Eric Conrad
...
print("1. Hunt and Kill - small maze")
grid = make_maze(m, n, "HuntKill1")
display_unicode(grid)
display_tree(grid, 'demos/hunt_and_kill_tree.gv')
display_maze(grid, 'demos/hunt_and_kill_maze1.gv')
check_maze(grid)

m, n = 30, 20                         # large rectangular mazes
print("2. Hunt and Kill - larger maze")
grid = make_maze(m, n, "HuntKill2")
display_maze(grid, 'demos/hunt_and_kill_maze2.gv')
check_maze(grid)

# END: hunt_and_kill_demo.py
