...
# -*- coding: utf-8 -*-
##############################################################################
# wilson_demo.py - test Wilson's algorithm
# Eric Conrad
...
##############################################################################
"""
wilson_demo.py - test the implementation of Wilson's algorithm
Copyright ©2020 by Eric Conrad
...
print("1. Wilson's algorithm - small maze")
grid = make_maze(m, n, "Wilson1")
display_unicode(grid)
display_tree(grid, 'demos/Wilson_tree.gv')
display_maze(grid, 'demos/Wilson_maze1.gv')
check_maze(grid)

m, n = 30, 20                         # large rectangular maze
print("2. Wilson's algorithm - larger maze")
grid = make_maze(m, n, "Wilson2")
display_maze(grid, 'demos/Wilson_maze2.gv')
check_maze(grid)
