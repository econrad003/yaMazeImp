...
# -*- coding: utf-8 -*-
##############################################################################
# eval_bfs.py - evaluate the breadth first search maze algorithm
# Eric Conrad
...
The BFS algorithm produces uninteresting mazes, but these may be helpful
...
with open(filename, 'w') as fp:
    ...
    fp.write("    As bad as a perfect maze can be!\n")
    fp.write("    Few dead ends, the result of awful texture.\n")
